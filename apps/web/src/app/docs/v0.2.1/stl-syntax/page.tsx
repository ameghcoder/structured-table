...
Learn More | [link text="Learn More" href="https://example.com" newTab="true" ]`}
            ...
            <TypographyP>
                Use `[button]` to create interactive elements, check this: <TypographyLink className="text-primary" href={"/docs/v0.2.1/stl-syntax/buttons/"}>How to add Buttons</TypographyLink>
            </TypographyP>
            <TypographyList list={[
...
Product 1st | ₹ 2,999 | [button text="Buy Now" url="/buy-a" action="action" targetId="target-id"]`}
            ...
            <TypographyP>
                For details and more examples, see <TypographyLink className="text-primary" href={"/docs/v0.2.1/stl-syntax/celltype"}>cellType documentation</TypographyLink>.
            </TypographyP>
            <TypographyBlockCode lang="STL">
