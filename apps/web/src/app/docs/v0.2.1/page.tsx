...
export default function IntroductionPage() {
    return (
        <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <TypographyList list={[
                <p key="1">Check out the <a href="/docs/v0.2.1/stl-syntax" className="font-medium text-primary underline underline-offset-4">STL Syntax</a> to learn how to write tables manually.</p>,
                <p key="2">Integrate it into <a href="/docs/v0.2.1/integration/sanity-studio" className="font-medium text-primary underline underline-offset-4">Sanity Studio</a> (the most popular use-case).</p>,
                <p key="3">Learn how to render tables on your <a href="/docs/v0.2.1/integration/frontend" className="font-medium text-primary underline underline-offset-4">Frontend Website</a>.</p>,
            ]} />
        </div>
    )
}
