...
const Footer = () => {
    return (
        <>
            <div className="relative z-50 bg-accent py-8 sm:p-8 lg:p-12 flex flex-col md:rounded-t-4xl md:border border-border shadow-xl">
                <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <div className="w-full sm:w-fit flex flex-col items-center md:items-end justify-center md:justify-end gap-4">
                        <Link title="Source on GitHub" href={REPO_URLS['structured-table']} className="w-fit flex gap-2 items-center rounded-full border-border border bg-background pl-4 group cursor-pointer">
                            ...
                            <span className="size-10 rounded-full bg-white p-1 ">
                                <img src="/assets/social/github.svg" alt="github logo" className="group-hover:scale-150 transition" />
                            </span>
                        </Link>
